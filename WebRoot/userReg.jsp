			...
			<form action="<%=path %>/userReg.action" name="form1" method="post">
				<table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
					...
					<tr>
						...
						<td bgcolor="#FFFFFF">
							&nbsp;
							<input type="password" name="userPw" style="width: 180px;"/>
						</td>
					</tr>
					<tr>
						<td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 11px;">
						...
						<td bgcolor="#FFFFFF">
							&nbsp;
							<input type="text" name="userRealname" style="width: 180px;"/>
						</td>
					</tr>
					<tr>
						<td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 11px;">
						...
						<td bgcolor="#FFFFFF">
							&nbsp;
							<input type="text" name="userAddress" style="width: 180px;"/>
						</td>
					</tr>
					<tr>
						<td height="30" align="right" bgcolor="#F9F9F9" style="font-size: 11px;">
					...
					<tr>
						...
						<td bgcolor="#FFFFFF">
							&nbsp;
							<input type="text" name="userTel" style="width: 180px;"/>
						</td>
					</tr>
					<tr>
