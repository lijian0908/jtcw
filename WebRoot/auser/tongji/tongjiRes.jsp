...
<%
    ...
    String shijian1=(String)request.getAttribute("shijian1");
    String shijian2=(String)request.getAttribute("shijian2");
   
    double shouru_1=0;
    double xiaofei_1=0;
    String shifoubaojing="";
	...
	defaultPieDataset.setValue("支出",xiaofei_1);
	
	JFreeChart freeChart=ChartFactory.createPieChart("分析饼图", defaultPieDataset,true,false,false);
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/images/allbg.gif'>
			...
			<table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" style="margin-top:8px">
		        <tr>
		            <td>
		                <%
		                   String url11="/jtcw/tutu/"+tu_mingzi;
		                %>
